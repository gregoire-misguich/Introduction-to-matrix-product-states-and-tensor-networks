...
limits = Limits(cutoff = 1e-10, maxdim = 32) # MPS truncation parameters
...
obs = ["osee.dat" => EE(N ÷ 2), "zmid.dat" => Z(N ÷ 2)] # Observables: OSEE and center magnetization
...
sim = SimData( # High-level simulation interface of TensorMixedStates
    ...
    phases = [
        ...
        Evolve(algo = ApproxW(order = 4, w = 2, n_hermitianize = 10), # W^{II} scheme
           limits = limits, duration = tmax, time_step = 0.05,
